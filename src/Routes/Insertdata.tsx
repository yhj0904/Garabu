...
function Insertdata() {
    ...
    const [formData, setFormData] = useState({
        id: new Object(),
        date: new Date(), // DateInput 컴포넌트로부터 받은 데이터를 저장하는 방법을 결정해야 함
        amount: 0,
        creater: '',
        customer: '',
        category: '',
    ...
    const handleChange = (e: any) => {
        ...
        setFormData(prevState => ({
            ...prevState,
            [name === "amountType" ? "amounttype" : name]: value,
        }));
    };
            ...
            <Row>
                <Col>
                    <Stack>
                        ...
                        <DateInput value={formData.date instanceof Date ? formData.date.toISOString().substring(0, 10) : ""} onChange={(newDate) => setFormData({ ...formData, date: new Date(newDate) })} />
